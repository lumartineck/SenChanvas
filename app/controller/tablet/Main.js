...
Ext.define('SenChanvas.controller.tablet.Main', {
    ...
    updateTransform:function(component){
        var me = this;
        component.element.setStyle('-webkit-transform', 'scaleX(' + me.getTransformDetails().scale +
            ') scaleY(' + me.getTransformDetails().scale + ') rotate(' + me.getTransformDetails().angle + 'deg)');
